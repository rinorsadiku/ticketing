...
var log = debug_1.default('MongoMS:MongoMemoryServer');
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (this.runningInstance) {
                    throw new Error('MongoDB instance already in status startup/running/error. Use debug for more info.');
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 1:
                        data = (_g.port = _h.sent(),
                            _g.dbName = db_util_1.generateDbName(instOpts.dbName),
                            _g.ip = (_c = instOpts.ip) !== null && _c !== void 0 ? _c : '127.0.0.1',
                            _g.storageEngine = (_d = instOpts.storageEngine) !== null && _d !== void 0 ? _d : 'ephemeralForTest',
                            _g.replSet = instOpts.replSet,
                            _g.dbPath = instOpts.dbPath,
                            _g.tmpDir = undefined,
                            _g);
